...
const String withoutPermissonAppCanErroText =
    "Without this permission app can not change picture.";
...
const enableMicrophoneText = "Enable Microphone";

///onboarding screen
const englishText = "English";
const firstScreenTextText = "Daily CBT session personalized for you";
...
const nameText = "Name";
const ageText = "Age";
const enterAgeText = "Enter age";
const genderText = "Gender";
const enterGenderText = "Enter gender";
