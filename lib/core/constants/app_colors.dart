...
var appBgColor = MaterialColor(bgColor.value, const <int, Color>{});
var appDarkBgColor = MaterialColor(bgColor.value, const <int, Color>{});
...
const borderPurpleColor = Color(0xFF352E40);
const borderPinkColor = Color(0xFF7A6082);
